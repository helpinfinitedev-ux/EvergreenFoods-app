...
export default function WeightLossEntry() {
    ...
    const loadInitialData = async () => {
        ...
        try {
            ...
            const historyData = await DataService.getWeightLossHistory(
                activeTab === 'mortality' ? 'MORTALITY' : 'WASTE'
            );
    ...
    const renderHeader = () => (
        <View style={styles.header}>
            ...
            <View style={styles.tabContainer}>
                <TouchableOpacity
                    style={[styles.tab, activeTab === 'mortality' && styles.activeTab]}
                    onPress={() => setActiveTab('mortality')}
                >
                    <Skull size={20} color={activeTab === 'mortality' ? '#fff' : '#888'} />
                    <Text style={[styles.tabText, activeTab === 'mortality' && styles.activeTabText]}>
                        Mortality
                    </Text>
                </TouchableOpacity>
                <TouchableOpacity
        ...
        <View style={styles.card}>
            ...
            <View style={styles.inputGroup}>
                ...
                <View style={styles.radioGroup}>
                    <TouchableOpacity
                        style={[styles.radioButton, mortalityType === 'Boiler' && styles.radioButtonActive]}
                        onPress={() => setMortalityType('Boiler')}
                    >
                        <Text style={[styles.radioText, mortalityType === 'Boiler' && styles.textWhite]}>Boiler</Text>
                    </TouchableOpacity>
                    <TouchableOpacity
                        style={[styles.radioButton, mortalityType === 'Chiller' && styles.radioButtonActive]}
                        onPress={() => setMortalityType('Chiller')}
                    >
                        ...
                        <View style={styles.overlayInfo}>
                            <View style={styles.badge}>
                                ...
                                <Text style={styles.badgeText}>
                                    {mortalityLocation
                                        ? `${mortalityLocation.lat.toFixed(4)}, ${mortalityLocation.lng.toFixed(4)}`
                                        : 'Locating...'}
                                </Text>
                            </View>
    ...
    const renderWasteForm = () => (
        <View style={styles.card}>
            ...
            <View style={styles.inputGroup}>
                ...
                <View style={styles.radioGroup}>
                    <TouchableOpacity
                        style={[styles.radioButton, wasteType === 'Boiler' && styles.radioButtonActive]}
                        onPress={() => setWasteType('Boiler')}
                    >
                        <Text style={[styles.radioText, wasteType === 'Boiler' && styles.textWhite]}>Boiler</Text>
                    </TouchableOpacity>
                    <TouchableOpacity
                        style={[styles.radioButton, wasteType === 'Chiller' && styles.radioButtonActive]}
                        onPress={() => setWasteType('Chiller')}
                    >
            ...
            <TouchableOpacity
                style={[styles.submitButton, { backgroundColor: '#FF9F0A' }, submitting && styles.disabledBtn]}
